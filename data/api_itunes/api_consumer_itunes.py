...
def format_iso_date(data_comentario):
    try:
        # Converte a string de data ISO 8601 para um objeto datetime
        date_obj = datetime.fromisoformat(data_comentario)
        date_formatted = date_obj.strftime("%d/%m/%Y")
        # Remove o fuso horário para torná-lo "offset-naive"
...
def api():
    ...
    df.to_csv(f'/opt/airflow/data/api_itunes/comentarios_{data_execucao}.csv', sep=";", index=False)
